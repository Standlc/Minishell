...
SRC_ARRAY_METHODS			=	join_str_arr.c

SRC_HEREDOCS				=	heredocs.c heredocs_utils.c

SRC_IS_FUNCTIONS			=	is_functions_1.c is_functions_2.c
...
SRC_PARSING					=	${addprefix array_methods/, ${SRC_ARRAY_METHODS}} ${addprefix heredocs/, ${SRC_HEREDOCS}} \
								...
								ft_realloc.c parse_line.c parse_line_utils.c print_error.c

SRC							=	${addprefix execution/, ${SRC_EXECUTION}} ${addprefix parsing/, ${SRC_PARSING}} \
								main.c close_program.c signals.c
